...
library(recount3)  # Para acceder a datos de expresión génica
library(ggplot2)   # Para visualización de datos
library(DESeq2)    # Para análisis de expresión diferencial
library(pheatmap)  # Para generar heatmaps
library(EnhancedVolcano) # Para gráficos tipo volcán
...
genes_interes <- c("SPN", "RUNX1", "CEBPA", "GATA2", "SPI1", "MYB", "FLI1", 
                   ...
                   "TP53", "RB1", "MDM2", "IKZF1", "DNTT", "RAG1", "RAG2", 
                   ...
                   "TGFBR1", "SMAD3", "SMAD4", "CD3D", "MYC", "RELA", "NFKB1", 
...
Un **MA plot** permite visualizar la expresión diferencial de los genes al comparar la **media de expresión normalizada** (Eje X) con el **log2FoldChange** (Eje Y). Este gráfico ayuda a identificar genes diferencialmente expresados al resaltar aquellos con mayor variabilidad y cambios significativos en su expresión.

```{r}

plotMA(res, ylim = c(-5, 5), cex = 1)
